...
public class LaunchBrowserThree {
	...
	public static void main(String[] args) {
		...
		System.out.println("********** myCurrUrl ******"+myCurrUrl);
		...
		driver.findElement(By.id("login1")).sendKeys("Rajendra Babu");

		System.out.println("login textbox is entered some values....");

		driver.findElement(By.id("password")).sendKeys("test Rajendra password");
